...
\begin{lstlisting}[style=pythonstyle, caption={Estructura simplificada de un nuevo \textit{loader}}, label={lst:technical_manual_loader_example}]
import torch
from torch import Tensor
...
\begin{lstlisting}[style=pythonstyle, caption={Registro de un nuevo \textit{loader}}, label={lst:technical_manual_loader_registry}]
...
El código fuente del proyecto se encuentra disponible en \textit{GitHub}. Se aceptan contribuciones siguiendo las pautas de desarrollo establecidas en este 
manual técnico. Para cualquier duda o sugerencia, se recomienda abrir un \textit{issue} en el repositorio o contactar directamente con el autor.
A continuación se proporciona el enlace al repositorio: \url{https://github.com/rubennmg/TFM_app}.
