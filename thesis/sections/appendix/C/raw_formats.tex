...
Las \autoref{tab:appendix_c_raw_formats_common_i} y
\autoref{tab:appendix_c_raw_formats_common_ii} resumen los formatos de imagen
...
\begin{table}[htbp]
    ...
    \label{tab:appendix_c_raw_formats_common_i}
\end{table}
...
\begin{table}[htbp]
    ...
    \label{tab:appendix_c_raw_formats_common_ii}
\end{table}
