...
implicaciones que tienen desde el punto de vista de la implementación.
...
En estos casos, la lectura suele apoyarse en bibliotecas específicas de decodificación RAW.

\newpage

\subsection{Formatos crudos más comunes}

La \autoref{tab:appendix_d_raw_formats_common_i} y la
