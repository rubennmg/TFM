...
El componente \textit{GUI} implementa la interfaz gráfica utilizando PyQt6 \cite{pyqt6}. Su responsabilidades 
son la presentación de la imagen, el manejo de la interacción del usuario y la visualización de información relevante sobre el procesamiento.
...
\begin{figure}[h!]
    ...
    \label{fig:31_gui_image_viewer_overview}
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{fig:32_gui_right_panel_overview}
\end{figure}
