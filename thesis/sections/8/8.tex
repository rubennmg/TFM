...
que puede ser de gran utilidad. En la \autoref{fig:45_logger_cuda_cpu} se muestra un ejemplo de esta funcionalidad, donde se observa la aplicación de ciertas operaciones en ambos dispositvos 
