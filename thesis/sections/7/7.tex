...
\begin{minipage}[t]{0.49\textwidth}
    ...
    El primero de ellos genera un perfil de ejecución en formato JSON que representa el \textit{pipeline} de operaciones. Su 
...
con salida estructurada en formato JSON.
...
\begin{itemize}[noitemsep]
    ...
    \texttt{-{}-bench-profile}, que recibe la ruta de un fichero JSON con la definición del
...
\begin{enumerate}[noitemsep]
    \item Carga y validación del perfil JSON recibido por \texttt{-{}-bench-profile}, que representa el \textit{pipeline} de operaciones a evaluar.
...
\begin{itemize}[noitemsep]
    ...
    lo serializa como una lista ordenada de operaciones y parámetros en formato JSON.
