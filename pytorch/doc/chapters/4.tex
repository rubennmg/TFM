...
En este caso, una imagen puede modelarse como un tensor tridimensional $I \in \mathbb{R}^{W \times H \times C}$, donde $W$ 
representa el ancho, $H$ la altura y $C$ el número de canales de color (por ejemplo, $C = 3$ para imágenes RGB).

Cada elemento $I_{w,h,c}$ del tensor almacena la intensidad del píxel ubicado en la posición $(h, w)$ del canal $c$. Esta representación 
...
\centering
	...
	[
		...
		% RGB Planes
		\foreach \z/\color in {3/blue!30, 1.5/green!30, 0/red!30} {
...
% --- Subfigure 2 ---
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\begin{tikzpicture}
		% RGB Planes
		\foreach \z/\color in {0/red!30,1.25/green!30,2.5/blue!30} {
			\filldraw[fill=\color, draw=black!50] 
